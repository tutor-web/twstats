...
```{r}
twstats_get_table('eurostat/tin00073/IS')[c('name', 'title', 'source')]
```
...
```{r, message=FALSE}
twstats_get_table('eurostat/tin00073/DE-FR')$title
twstats_get_table('eurostat/tin00073/DE-FR')$data()
```
